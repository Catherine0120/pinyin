...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", type=str, default="./data/input.txt", help="choose an input file")
    parser.add_argument("-o", "--output", type=str, default="./data/output.txt", help="choose an output file")
